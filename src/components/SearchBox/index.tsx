  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        type="text"
        className={`${className} focus:border-[#160783] transition-all duration-300 transactionSearhBox rounded border-[1px] border-[#A4A4A4] py-[12px] pr-[30px] !pl-[30px] h-[36px] font-normal text-[12px] overflow-ellipsis overflow-hidden whitespace-nowrap`}
        value={value}
        onChange={onChange}
        title="Search Box"
      />
...
//         placeholder={customPlaceholder}
//         type="text"
//         className={`${className}  focus:border-[#160783] transition-all duration-300 transactionSearhBox rounded border-[1px] border-[#A4A4A4] py-[12px] pr-[5px] !pl-[30px] h-[36px] font-normal text-[12px] `}
//         // value={value}
//         onChange={onChange}
//         title="Search Box"
//       />
