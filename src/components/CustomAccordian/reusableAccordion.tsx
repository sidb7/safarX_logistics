        ...
        <div className="flex flex-col gap-y-4 ">
            ...
            `}
                    ...
                    >
                        ...
                        <svg
                            className={`w-5 h-5 transform ${activeItem === roleData.id ? "rotate-180" : ""
                                }`}
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <svg
                                                className={`w-5 h-5 transform ${activeSubItem === menuData?.id ? "rotate-180" : ""
                                                    }`}
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                stroke="currentColor"
                                                            ...
                                                            return (
                                                                <div key={index3}>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <svg
                                                                            className={`w-5 h-5 transform ${activeSubItem2 === menuPagesData?.id
                                                                                    ? "rotate-180"
                                                                                    : ""
                                                                                }`}
                                                                            fill="none"
