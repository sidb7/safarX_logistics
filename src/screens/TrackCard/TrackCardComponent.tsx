...
const TrackCardComponent = () => {
  return (
    <div className="border rounded-xl  bg-[#e7e4ff] p-4">
      ...
      <div>
        <button className="w-full border-[#160783] border text-sm rounded-lg hover:text-white hover:bg-[#160783] text-[#160783] py-2 duration-150 transition mt-4">
          Track Order{" "}
        </button>
      </div>
    </div>
