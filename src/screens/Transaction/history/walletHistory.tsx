...
export const WalletHistory: React.FunctionComponent<IWalletProps> = ({
  data,
}) => {
      ...
      >
        ...
        <Collapsible open={onOpen} trigger="">
          <div className="flex flex-col ml-4 mt-4">
            <span className="text-[10px] text-[#777777] font-normal">Name</span>
          ...
          <div className="grid grid-cols-2 ml-4 mt-2">
            ...
            <div className="flex flex-col border-[#E8E8E8] border-l-[1px] mb-4">
