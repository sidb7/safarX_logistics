  ...
  return (
    <div>
      ...
      <p>
        ...
        <strong>AVN Business Solutions Private Limited </strong>,
        <strong>AVN Business Solutions Private Limited,</strong> a company
        registered under the Companies Act, 1956, having its corporate office at
        12 A, 3rd Floor, Techniplex–II, Off, Veer Savarkar Flyover, Goregaon
        West, Mumbai, Maharashtra 400062, (hereinafter referred to as "Service
        Provider”), which means and include, unless repugnant to the context or
        meaning thereof mean and include its affiliates, liquidators,
      ...
      <p>
        ...
        you register for or use on <strong>Shipyaari</strong> website or{" "}
        <strong>Shipyaari</strong> mobile application.
      </p>
      <br />
      ...
      <p>
        ...
        <strong>Shipyaari</strong>.
      </p>
      <br />

      <p>Now This Agreement Witnessed as Under:</p>
      <br />
      ...
      <p>
        ...
        shared by the <strong>Shipyaari</strong>) containing the details of the
        shipment for which the service provider is to provide delivery services
        or cash pickup services as the case may be.
      </p>
      <br />
      <h2 className="font-bold">1. Scope Of Services</h2>
      <br />
      ...
      <p>1.2. Detailed scope of services in Annexure I.</p>
      <br />
      ...
      <p>
        ...
        <strong>Shipyaari</strong> the fees and other amounts as mentioned
        against each service more particularly described in Annexure II for
        Domestic Logistics, Annexure III for International Services and Annexure
        IV for Fulfilment and Logistics services respectively.
      </p>
      ...
      <p>
        2.3. <strong>Shipyaari</strong> may add new services for additional fees
        and charges or may amend fees and charges for existing services, at any
        time in its sole discretion. Any change in the rate becomes effective
        from the date when <strong>Shipyaari</strong> intimates the customer of
        such rate revision.
      </p>

      <p>
        2.4. <strong>Shipyaari</strong> is registered under MSME and late
        payments shall attract penalty as specified under MSMED Act 2006 (The
        Micro, Small and Medium Enterprises Development Act, 2006).
      </p>

      <h2 className="font-bold">3. Obligations Of the Customer</h2>
      <br />
      ...
      <p>
        ...
        breach of any laws in force. <strong>Shipyaari</strong> shall not be
        liable for the Delivery of any such Shipments. Without prejudice to the
        generality of the aforesaid, an indicative list of the banned or
        prohibited products is given in Annexure V.
      </p>

      <p>
        3.2. Any person delivering any dangerous, hazardous or banned goods to
        <strong>Shipyaari</strong> or causing <strong>Shipyaari</strong> to
        handle or deal with any such goods shall be liable for all loss or
        damage caused thereby and shall indemnify <strong>Shipyaari</strong>{" "}
        ...
        with at the sole discretion of <strong>Shipyaari</strong> or any other
        person in whose custody they may be at the relevant time. The expression
        “goods” likely to cause “damage” include goods likely to harbor or
        encourage vermin or other pests.
      </p>

      <p>
        3.3. The Customer warrants and represents that any information customer
        gives to <strong>Shipyaari</strong> will always be true, accurate,
        correct, complete and up to date, to the best of his/her knowledge.
      </p>
      ...
      <p>
        3.7. <strong>Shipyaari</strong> will not accept or deal with any
        noxious, dangerous, hazardous or inflammable or explosive goods or any
        goods likely to cause damage.
      </p>

      <h2 className="font-bold">4. Undelivered Shipments/Consignments</h2>
      ...
      <h2 className="font-bold">5. Insurance</h2>
      ...
      <p>
        ...
        destination at his/her own cost. <strong>Shipyaari</strong> shall not be
        liable for insuring the consignment.
      </p>

      <p>
        5.2. Upon specific request made by the customer,{" "}
        <strong>Shipyaari</strong> may arrange insurance of consignment on
        behalf of customer for the declared value of goods in respect of loss of
        physical damage to such consignment(s).
        <strong>Shipyaari</strong> shall be only responsible for the
        administrative facilitation and arrangement of the insurance policy. The
        policy will be subject to respective terms and conditions.
      </p>

      <h2 className="font-bold">6. Risk And Title</h2>
      ...
      <p>
        ...
        transported by <strong>Shipyaari</strong> at all times.{" "}
        <strong>Shipyaari</strong> will act as a custodian, not being an agent
        of the customer.
      </p>
      <br />
      <h2 className="font-bold">7. Confidentiality</h2>
      <br />
      ...
      <p>
        ...
        <strong>Shipyaari</strong> through email, SMS, Whatsapp and any other
        mode as agreed by the Parties from time to time.
      </p>

      <h2 className="font-bold">8. Indemnities</h2>

      <p>
        The customer hereby agrees to indemnify, defend and hold{" "}
        <strong>Shipyaari</strong>, its affiliates, officers, directors,
        employees, contractors, sub-contractors, consultants, licensors, other
        third party service providers, agents and representatives harmless from
        and against claims, demands, actions, liabilities, costs, interest,
        damages and expenses of any nature whatsoever (including all legal and
        other costs, charges and expenses) incurred or suffered (directly or
        indirectly) by <strong>Shipyaari</strong> or its employees, on account
        of: (a) customer’s access to or use of services; (b) violation of this
        agreement or any terms of use of the services customer (and/or its
        officers, directors and employees); (c) violation of applicable law by
        the customer; (d) wrongful or negligent act or omission of customer
        (and/or its officers, directors and employees); (e) any third party
        action or claim made against <strong>Shipyaari</strong>, by reason of
        any actions undertaken by the customer (and/or its officers, directors
        and employees); (f) any duties, taxes, octroi, cess, clearance charges
        and any other charge/levy by whatsoever name called, levied on the
        shipments.
      </p>
      ...
      <p>
        9.1. <strong>Shipyaari</strong> or any of its directors, employees,
        agents, contractors shall not be liable to the customer, whether in
        tort, contract or otherwise, for any consequential, indirect, punitive,
        exemplary or incidental damages, lost profits or lost business
        opportunities.
      </p>

      <p>
        9.2. The maximum liability of <strong>Shipyaari</strong> and the sole
        and exclusive remedy of the customer for the damage or loss or theft or
        misappropriation of any consignment caused due to gross negligence or
        willful misconduct of <strong>Shipyaari</strong> shall be as per
        Annexure II.
      </p>
      ...
      <p>
        10.2. Customer agrees that <strong>Shipyaari</strong> may use customer’s
        name and logo on their website and social media platform with the intent
        to list the customer as a customer of <strong>Shipyaari</strong>. It is
        clarified that all rights, title and interest in the logo and name
        remain with the Customer.
      </p>

      <h2 className="font-bold">11. Term And Termination</h2>
      ...
      <p>
        <strong>Shipyaari</strong> shall not be liable for any loss or damage to
        the consignment or a delay in picking up or delivery of the consignment
        or delay in delivery is caused due to acts of God, force majeure events
        including but not limited to strikes, riots, political or other
        disturbances, fire, floods, tsunami, pandemic, accident of the vehicle
        or caused due to any factors beyond the control of{" "}
        <strong>Shipyaari</strong>.
      </p>
      ...
      <br />
      <h2 className="font-bold">14. Jurisdiction</h2>
      <p>
      ...
      <h2 className="font-bold">15. General</h2>
      <p>
      ...
      <p>
        In the case of notices to <strong>Shipyaari</strong>: <br />
        <strong>
        ...
        <a href="email:legal@<strong>Shipyaari</strong>.com">
          legal@<strong>Shipyaari</strong>.com
        </a>
      </p>
      ...
      <h2 className="text-blue-300">Annexure I Scope of work and Rate card</h2>

      <h2 className="font-bold">1. Forward delivery of the shipments</h2>
      <br />
      <p>
      ...
      <h2 className="font-bold">2. Returns/RTO of the shipments</h2>
      <br />
      <p>
      ...
      <h2 className="font-bold">3. Reverse pickups</h2>
      <br />
      <p>
      ...
      <h2 className="font-bold">4. POD</h2>
      <br />
      <p>
      ...
      <h2 className="font-bold">5. Demurrage</h2>
      <br />
      <p>
      ...
      <h2 className="font-bold">6. Customer hereby agrees that it shall:</h2>
      <p>
      ...
      <h2 className="font-bold">COD terms</h2>
      <table>
        <thead>
          <tr>
            <th>Express COD</th>
      ...
      <h2 className="font-bold">Annexure II Domestic Services:</h2>
      ...
      <h2 className="font-bold">Annexure III International Services</h2>
      ...
      <h2 className="font-bold">Annexure IV Fulfilment and Warehousing</h2>

      <h2 className="font-bold">
        Annexure V List of Banned or Prohibited Items (Indicative)
      </h2>
      <h3 className="font-bold">Dangerous Products</h3>
      <ul>
      ...
      <h3 className="font-bold">Restricted Items</h3>
      <ul>
      ...
      <h2 className="font-bold">Postpaid terms and conditions</h2>
      ...
      <br />
      <h2 className="font-bold">Letter of Intimation</h2>
      <br />
      <p className="text-center underline">To Whomsoever It May Concern,</p>
      <p>
        This is to inform that I/User has approached{" "}
        <strong>AVN Business Solutions Private Limited </strong>(Hereinafter
        Referred to as "<strong>Shipyaari</strong>”) to open a logistics
        services account as they cater to many value-added services which are
        not available from a particular direct courier partner in some of the
        cases as solutions provided by them are single window solutions.
      </p>
      <p>
        I state that the services provided by a direct carrier as compared to
        those provided by <strong>Shipyaari</strong> are different & as{" "}
        <strong>Shipyaari</strong> is enabling more comprehensive logistics
        solutions which are essential for business growth.
      </p>
    </div>
  );
};
