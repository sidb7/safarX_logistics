...
export const EditProfileKyc = () => {
  return (
    <div className="mx-4 mt-4 space-y-4 lg:grid lg:grid-cols-3 lg:gap-4">
      ...
      <CustomInputBox label="GST Document" className="!font-normal" />
      <CustomInputBox label="Aadhar Documents" className="!font-normal" />
      <CustomInputBox label="PAN Documents" className="!font-normal" />
    </div>
  );
};
