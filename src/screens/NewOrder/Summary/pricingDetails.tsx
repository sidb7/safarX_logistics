            ...
            {showTooltip && variableServiceKeys.length > 0 && (
              ...
              >
                <div className="flex justify-between items-center mb-2 border-b border-[#E0E8FF] pb-2">
                  <p className="text-[14px] font-medium text-[#004EFF]">Order Price Breakdown</p>
                  <p className="text-[12px] font-medium text-[#004EFF]">
                    Total: {`\u20B9`} {roundedOrderPrice?.toLocaleString("en-IN")}
                  </p>
                </div>
                <div className="max-h-[250px] overflow-y-auto pr-1">
                  ...
                  <div className="border-b border-[#E0E8FF] pb-2 mb-2">
                    <div className="flex justify-between py-1 text-[12px]">
                      ...
                      <p>{`\u20B9`} {baseValue?.toLocaleString("en-IN")}</p>
                    </div>
                    <div className="flex justify-between py-1 text-[12px]">
                      <p className="text-[12px] font-medium">Additional Charge:</p>
                      <p>{`\u20B9`} {addValue?.toLocaleString("en-IN")}</p>
                    </div>
                  </div>
                  ...
                  <div className="mb-2">
                    <div className="flex justify-between py-1 text-[12px] font-medium">
                      ...
                      <p>{`\u20B9`} {variablesValue?.toLocaleString("en-IN")}</p>
                    </div>
                    
                    {/* List all variable service charges */}
                    <div className="pl-2">
                      {variableServiceKeys.map((key) => (
                        <div key={key} className="flex justify-between py-1 text-[12px] border-b border-[#F2F6FF] last:border-0">
                          <p className="text-[12px] font-normal">
                            {formatLabel(key)}:
                          </p>
                          <p>
                            {`\u20B9`} {((variableServices?.[key] as number) || 0).toLocaleString("en-IN")}
                          </p>
                        </div>
                      ))}
                    </div>
