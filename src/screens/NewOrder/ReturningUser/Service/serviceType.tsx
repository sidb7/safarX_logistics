                ...
                return(
                    <>
                     <div className="p-[12px] shadow-lg rounded-lg border-[1px] border-[#E8E8E8] bg-[#FFFFFF]  my-4">
                        ...
                        <div className="flex">
                            <p className="text-[14px] font-medium ml-1">{each.servicePrice}</p>
                            <p className="text-[14px] ml-1 text-[#004EFF]">{each.serviceSpan}</p>
                        </div>
                        <div>
                            <p className="text-[14px] text-[#004EFF] ml-1">{each.serviceETA}</p>
                        </div>
                    </div>
                    </>
                )
