...
const CustomPickupLocation: React.FunctionComponent<IPickupData> = ({props}) => {
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              {props.map((each:any,index:any)=>{
                ...
                <div className="flex items-center mt-5">
                    <Checkbox />
                    <span className="text-[12px] text-[#3371FF] font-medium">{each.text}</span>
                </div>
                <div>
                    <p className="text-[12px] font-normal ml-7 w-[200px]">{each.address}</p>
                </div>
