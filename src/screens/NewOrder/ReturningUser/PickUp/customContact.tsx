...
const CustomPickupLocation: React.FunctionComponent<IContactData> = ({props}) => {
        ...
        {props.map((each:any,index:any)=>{
            return(
                ...
                <div className="flex items-center  mt-3">
                    <div><Checkbox/></div>
                    <p className="text-[12px] text-[#3371FF] font-medium">{each.role}</p>
                </div>
            ...
            <div className="ml-5">
                    ...
                    <div className="flex items-center gap-x-2 mt-2">
                        ...
                        <p className="text-[12px] font-normal">{"+" + each.personContact}</p>
                    </div>
                </div>
            </div>
