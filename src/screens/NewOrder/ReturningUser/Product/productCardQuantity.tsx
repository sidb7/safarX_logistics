...
const ProductCardQuantity: React.FunctionComponent<IPackageBoxProps> = ({props, className}) => {
  return (
    <div>
    {
        props.map((each, index) => {
            return(
                <div className={{} ? "relative py-2 mt-4" : "py-2"}>
                    <div className={`${className} flex flex-col  py-2 justify-center h-[94px] w-[238px] border-2 rounded-md px-4`}>
                        {each.recommended ? (
