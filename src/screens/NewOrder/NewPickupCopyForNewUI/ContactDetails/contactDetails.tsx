...
const ContactDetails: React.FunctionComponent<IContactDetailsProps> = ({
  ...
  return (
    <div>
      <div className="flex flex-row items-center gap-2  md:col-span-3 mb-5 md:mb-[23px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-8">
        <div className="mb-4 md:col-span-2  md:mb-6 md:mr-6 ">
          <CustomInputBox
        ...
        <div className="mb-4 md:mb-6 md:mr-6 ">
          <CustomInputBox
            label="Mobile Number"
        ...
        <div className="mb-4 md:mb-6 md:mr-6 md:col-span-2">
          <CustomInputBox
