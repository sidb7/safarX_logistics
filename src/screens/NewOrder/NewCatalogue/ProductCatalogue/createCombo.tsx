...
const CreateCombo: React.FunctionComponent<ISearchProductProps> = (
    props
) => {
    const {
    ...
    const handleVolumCalc = () => {
        ...
        const updatedProductInputState = products.filter((isSelectedFilterData: any) => isSelectedFilterData?.selected);
        ...
        setComboData({ ...comboData, totalVolumetricWeight: volumetricWeightLocal, deadWeight: deadWeightLocal, appliedWeight: appliedWeightLocal })
    };
