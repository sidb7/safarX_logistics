    ...
    return (
      <div>
        <div className="flex justify-end mb-4">
          <div className="border-[#AFAFAF] w-[250px]  !h-[36px] rounded-md">
            <DatePicker
              selectsRange={true}
              startDate={startDate}
              endDate={endDate}
              ...
              className="cursor-pointer removePaddingPlaceHolder !w-[250px] border !h-[30px] border-[#AFAFAF] rounded-md text-[12px] font-normal flex items-center datepickerCss pl-6"
