...
const DeliveryAddress = ({
  ...
  const deliveryData = updatedData?.deliveryAddress || {};
  ...
  const handleChange = async (fieldName: string, value: any) => {
    ...
    if (
      ...
      const updatedContact = {
        ...
        name:
          fieldName === "contactName" ? value : deliveryAddress?.contact?.name,
        mobileNo:
          fieldName === "mobileNo" ? value : deliveryAddress?.contact?.mobileNo,
        emailID:
          fieldName === "emailID" ? value : deliveryAddress?.contact?.emailID,
      };
  ...
  useEffect(() => {
    ...
    // Call priorValidations with the current deliveryData
