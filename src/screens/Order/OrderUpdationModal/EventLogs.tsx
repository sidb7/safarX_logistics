...
const EventLogs = (completeData: any) => {
  ...
  return (
    <div className="m-4">
      ...
      {accordianOpen &&
        (eventLogs?.length !== 0 ? (
          <div className="mb-4 border-l border-r border-b rounded-lg border-[#E8E8E8] px-4 py-2 ">
            <div>
                ...
                return (
                  <div className="flex flex-col gap-y-4 py-4 my-4 border border-black-200 px-4 rounded-lg bg-gray-50">
                    <div className="flex justify-between">
                      <p className="text-base font-semibold">AWB:</p>
                      <p className="text-[18px]">
                        {event?.awb === "" || event?.awb === null
                          ? "-"
                          : event?.awb}
                      </p>
                    </div>
                    <div className="flex justify-between">
                      <p className="text-base">Current Status</p>
                    ...
                    <div className="flex justify-between gap-x-10">
                      <p className="text-base">Time Stamp</p>
                      <p className="text-base">
          ...
          <div className="flex justify-center items-center h-32 border-b border-l border-r rounded-lg border-[#E8E8E8]">
            <p>No Data Found</p>
          </div>
        ))}
    </div>
