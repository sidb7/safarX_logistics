...
const WeightFreeze: React.FunctionComponent = () => {
    ...
    const [renderingComponents, setRenderingComponents] =
    ...
    const [discrepancyDetailsModal, setDiscrepancyDetailsModal] =
        useState(false);
    ...
    const getWeightDispute = async (searchText?: any) => {
        ...
        if (listTab[renderingComponents]?.key === "New_Discrepancy") {
            payload.customFilter.actionStatus =
                listTab[renderingComponents]?.payload;
        ...
        try {
            ...
            if (responseData?.status) {
                ...
                setWeightManagementdata(
                    responseData?.data?.[0]?.tableData?.[0]
                );
                        ...
                        <div className="lg:mb-24">
                           ...
                           ${
                            ...
                            <RightSideModal
                                ...
                                onClose={() =>
                                    setDiscrepancyDetailsRightModal(false)
                                }
                                className="!w-[389px]"
                            >
                                <DiscrepancyDetails
