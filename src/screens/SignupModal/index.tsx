    ...
    <div className="h-screen flex flex-col justify-between">
      ...
      <div className="flex justify-center">
        <div>
          ...
          <p className="text-center text-[12px] font-normal leading-4 text-[#BBBBBB] mt-2">
      ...
      <div className="flex justify-center px-5 my-5">
        <CustomButton
          className="!bg-[#E8E8E8] !font-medium !text-[14px] !text-[#BBBBBB]"
          text={"continue"}
      ...
      <CustomBottomModal
        isOpen={mobileVerificationModal}
