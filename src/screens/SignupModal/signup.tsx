...
const Index = () => {
  ...
  return (
    <div className="flex flex-col gap-y-1">
      ...
      <div className="flex flex-col mt-7 mx-16 gap-y-2">
        <p className="text-center	 text-[22px] font-medium">Welcome to Shipyaari</p>
        <p className="text-center	 font-thin">
          Fast and Easy Shipping from your doorstep to your customer's.{" "}
        </p>
      </div>
      <div className=" flex flex-col mx-16  gap-y-6 mb-8">
        <div className="flex ">
