...
//   const [pendingIdenticalCheckbox, setPendingIdenticalCheckbox] = useState<boolean>(false);
...
//     [productId: number]: boolean;
//   }>({});
//   const [showBoxSearchResults, setShowBoxSearchResults] = useState<boolean>(false);
...
//   const productSearchRefs = useRef<{[productId: number]: HTMLDivElement | null}>({});
...
//         if (productSearchRefs.current[Number(productId)] &&
//             !productSearchRefs.current[Number(productId)]?.contains(event.target as Node)) {
...
//       if (boxSearchRef.current && !boxSearchRef.current.contains(event.target as Node)) {
...
//   const selectProductFromSearch = (productId: number, suggestion: ProductSuggestion) => {
...
//                       </button>
//                       <button
//                         className={`p-2 ${savedProducts[product.id] ? "text-blue-500 cursor-not-allowed" : "text-gray-500 cursor-pointer"}`}
//                         onClick={() => saveProduct(product.id)}
//                         title={savedProducts[product.id] ? "Product saved" : "Save product"}
...
//                         <div className="flex-grow min-w-[200px] relative" ref={el => productSearchRefs.current[product.id] = el}>
//                           <FloatingLabelInput
//                             placeholder="Product Name"
//                             value={product.name.toString()}
//                             onChangeCallback={(value) => handleProductNameSearch(product.id, value)}
...
//                 <button
//                   className={`p-2 ${savedBox ? "text-blue-500 cursor-not-allowed" : "text-gray-500 cursor-pointer"}`}
//                   onClick={saveBox}
...
//                 onChangeCallback={(value) => handleBoxNameSearch(value)}
//                 icon={<img src={searchIcon} alt="Search" />}
//               />
...
//                       </div>
//                       <div className="text-xs bg-gray-200 px-2 py-1 rounded">
//                         {suggestion.length} x {suggestion.breadth} x {suggestion.height} {suggestion.measureUnit}
//                       </div>
//                     </div>
//                   ))}
//                 </div>
...
//                   You are about to make all {boxCount} boxes identical using the data from <span className="font-medium">Box {selectedBox}</span>.
//                 </p>
//                 <p className="text-gray-600">
//                   This will copy all products and properties from Box {selectedBox} to all other boxes.
//                   Any existing data in other boxes will be overwritten.
//                 </p>
//               </div>
//             </div>
//           </div>
