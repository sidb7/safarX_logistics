...
describe("Login and Order Pickup Tests", () => {
    beforeEach(
        "should successfully create an order with pickup details",
        () => {
    ...
    it("should successfully create an order with pickup details", () => {
        ...
        cy.xpath("//*[text()='Pick-Up Address Info Added']").should(
            "be.visible"
        );
        ...
        cy.xpath("//*[text()='Product Created Successfully']").should(
            "be.visible"
        );
        ...
        cy.xpath("//*[text()='AWB Cancel Process Started']").should(
            "be.visible"
        );
        cy.wait(5000);
    });
